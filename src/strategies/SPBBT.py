...
class SPBBT:
    ...
    def trade_logic(self, current_close, current_high, current_low, current_vwap, current_spt, bb_upper, bb_lower):
        """
        :param current_close: Close price of the current candle.
        :param current_high: High price of the current candle.
        :param current_low: Low price of the current candle.
